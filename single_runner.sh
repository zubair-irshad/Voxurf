...
echo python run.py --config ${CONFIG}/coarse.py -p ${WORKDIR} --no_reload --sdf_mode voxurf_coarse --scene ${SCENE}
python run.py --config ${CONFIG}/coarse.py -p ${WORKDIR} --no_reload --sdf_mode voxurf_coarse --scene ${SCENE}
